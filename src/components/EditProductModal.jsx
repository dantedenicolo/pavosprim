...
export default function EditSellProductModal({
	isOpen,
	onOpenChange,
	product,
}) {
	...
	useEffect(() => {
		setSelectedStoreType(product?.storeType);
	...
	const handleEditSellProduct = async () => {
								...
								<>
									...
									<ModalBody className="dark">
										<Select
											...
											selectedKeys={[selectedProductID]}
										>
											<SelectItem
												value="product"
										...
										<Select
											...
											selectedKeys={[selectedStoreType]}
										>
